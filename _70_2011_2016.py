...
for epoch in range(epochs):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), 'best_vae_model_2011_2016_early.pth')
...
path_2016_22.load_state_dict(torch.load('best_vae_model_2011_2016_early.pth', map_location=torch.device('cpu')))
