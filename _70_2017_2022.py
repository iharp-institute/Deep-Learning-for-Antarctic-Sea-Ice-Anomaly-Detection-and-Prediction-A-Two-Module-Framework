...
x_train = total_images[0:train_len-1] 
y_train = total_images[1:train_len] 


_test_len,total_len = year_trace[2017][0], year_trace[2021][1] 
...
for epoch in range(epochs):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), 'best_vae_model_2017_2022_early.pth')
